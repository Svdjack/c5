...
use PropelModel\Map\ChildTableMap;
...
/**
 * Base class that represents a query for the 'firm_childs' table.
 *
 *
 *
 * @method     ChildChildQuery orderByid($order = Criteria::ASC) Order by the id column
 * @method     ChildChildQuery orderByFirmId($order = Criteria::ASC) Order by the firm_id column
 * @method     ChildChildQuery orderByValue($order = Criteria::ASC) Order by the value column
 *
 * @method     ChildChildQuery groupByid() Group by the id column
 * @method     ChildChildQuery groupByFirmId() Group by the firm_id column
 * @method     ChildChildQuery groupByValue() Group by the value column
 *
 ...
 *
 * @method     ChildChildQuery leftJoinFirm($relationAlias = null) Adds a LEFT JOIN clause to the query using the Firm relation
 * @method     ChildChildQuery rightJoinFirm($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Firm relation
 * @method     ChildChildQuery innerJoinFirm($relationAlias = null) Adds a INNER JOIN clause to the query using the Firm relation
 *
 ...
 *
 * @method     ChildChild findOneByid(int $id) Return the first ChildChild filtered by the id column
 * @method     ChildChild findOneByFirmId(int $firm_id) Return the first ChildChild filtered by the firm_id column
 * @method     ChildChild findOneByValue(string $value) Return the first ChildChild filtered by the value column *
 ...
 *
 * @method     ChildChild requireOneByid(int $id) Return the first ChildChild filtered by the id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildChild requireOneByFirmId(int $firm_id) Return the first ChildChild filtered by the firm_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildChild requireOneByValue(string $value) Return the first ChildChild filtered by the value column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildChild[]|ObjectCollection findByid(int $id) Return ChildChild objects filtered by the id column
 * @method     ChildChild[]|ObjectCollection findByFirmId(int $firm_id) Return ChildChild objects filtered by the firm_id column
 * @method     ChildChild[]|ObjectCollection findByValue(string $value) Return ChildChild objects filtered by the value column
...
abstract class ChildQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \PropelModel\Base\ChildQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\PropelModel\\Child', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = ChildTableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
    ...
    {
        $sql = 'SELECT id, firm_id, value FROM firm_childs WHERE id = :p0';
        try {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj = new ChildChild();
            $obj->hydrate($row);
            ChildTableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(ChildTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(ChildTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterByid($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(ChildTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(ChildTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ChildTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByFirmId($firmId = null, $comparison = null)
    {
        if (is_array($firmId)) {
            $useMinMax = false;
            if (isset($firmId['min'])) {
                $this->addUsingAlias(ChildTableMap::COL_FIRM_ID, $firmId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($firmId['max'])) {
                $this->addUsingAlias(ChildTableMap::COL_FIRM_ID, $firmId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ChildTableMap::COL_FIRM_ID, $firmId, $comparison);
    }
    ...
    public function filterByValue($value = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ChildTableMap::COL_VALUE, $value, $comparison);
    }
    ...
    public function filterByFirm($firm, $comparison = null)
    {
        if ($firm instanceof \PropelModel\Firm) {
            return $this
                ->addUsingAlias(ChildTableMap::COL_FIRM_ID, $firm->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(ChildTableMap::COL_FIRM_ID, $firm->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    {
        if ($child) {
            $this->addUsingAlias(ChildTableMap::COL_ID, $child->getid(), Criteria::NOT_EQUAL);
        }
    ...
    /**
     * Deletes all rows from the firm_childs table.
     *
