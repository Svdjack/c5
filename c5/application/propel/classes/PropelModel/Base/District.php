...
abstract class District implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\PropelModel\\Map\\DistrictTableMap';
    ...
    /**
     * Initializes internal state of PropelModel\Base\District object.
     */
     ...
     * @return $this|\PropelModel\District The current object (for fluent API support)
     */
    ...
    public function setData($v)
    {
        ...
        if ($this->data !== $v) {
            $this->data = $v;
            $this->modifiedColumns[DistrictTableMap::COL_DATA] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : DistrictTableMap::translateFieldName('Data', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = DistrictTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\PropelModel\\District'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(DistrictTableMap::COL_DATA)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\PropelModel\District
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\PropelModel\District The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DistrictTableMap::COL_DATA)) {
            $criteria->add(DistrictTableMap::COL_DATA, $this->data);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PropelModel\District (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PropelModel\District Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildDistrict is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildDistrict The current object (for fluent API support)
     */
     ...
     * @return ObjectCollection|ChildFirm[] List of ChildFirm objects
     */
    public function getFirmsJoinRegion(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildFirmQuery::create(null, $criteria);
