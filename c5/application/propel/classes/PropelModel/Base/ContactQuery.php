...
use PropelModel\Map\ContactTableMap;
...
/**
 * Base class that represents a query for the 'firm_contacts' table.
 *
 *
 *
 * @method     ChildContactQuery orderByid($order = Criteria::ASC) Order by the id column
 * @method     ChildContactQuery orderByFirmId($order = Criteria::ASC) Order by the firm_id column
 * @method     ChildContactQuery orderByType($order = Criteria::ASC) Order by the type column
 * @method     ChildContactQuery orderByValue($order = Criteria::ASC) Order by the value column
 *
 * @method     ChildContactQuery groupByid() Group by the id column
 * @method     ChildContactQuery groupByFirmId() Group by the firm_id column
 * @method     ChildContactQuery groupByType() Group by the type column
 * @method     ChildContactQuery groupByValue() Group by the value column
 *
 ...
 *
 * @method     ChildContactQuery leftJoinFirm($relationAlias = null) Adds a LEFT JOIN clause to the query using the Firm relation
 * @method     ChildContactQuery rightJoinFirm($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Firm relation
 * @method     ChildContactQuery innerJoinFirm($relationAlias = null) Adds a INNER JOIN clause to the query using the Firm relation
 *
 ...
 * @method     ChildContact findOneByFirmId(int $firm_id) Return the first ChildContact filtered by the firm_id column
 * @method     ChildContact findOneByType(string $type) Return the first ChildContact filtered by the type column
 * @method     ChildContact findOneByValue(string $value) Return the first ChildContact filtered by the value column *
 ...
 * @method     ChildContact requireOneByFirmId(int $firm_id) Return the first ChildContact filtered by the firm_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildContact requireOneByType(string $type) Return the first ChildContact filtered by the type column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildContact requireOneByValue(string $value) Return the first ChildContact filtered by the value column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildContact[]|ObjectCollection findByFirmId(int $firm_id) Return ChildContact objects filtered by the firm_id column
 * @method     ChildContact[]|ObjectCollection findByType(string $type) Return ChildContact objects filtered by the type column
 * @method     ChildContact[]|ObjectCollection findByValue(string $value) Return ChildContact objects filtered by the value column
...
abstract class ContactQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \PropelModel\Base\ContactQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\PropelModel\\Contact', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, firm_id, type, value FROM firm_contacts WHERE id = :p0';
        try {
    ...
    public function filterByFirmId($firmId = null, $comparison = null)
    {
        if (is_array($firmId)) {
            $useMinMax = false;
            if (isset($firmId['min'])) {
                $this->addUsingAlias(ContactTableMap::COL_FIRM_ID, $firmId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($firmId['max'])) {
                $this->addUsingAlias(ContactTableMap::COL_FIRM_ID, $firmId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ContactTableMap::COL_FIRM_ID, $firmId, $comparison);
    }
    ...
    public function filterByType($type = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ContactTableMap::COL_TYPE, $type, $comparison);
    }
    ...
    public function filterByValue($value = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ContactTableMap::COL_VALUE, $value, $comparison);
    }
    ...
    public function filterByFirm($firm, $comparison = null)
    {
        if ($firm instanceof \PropelModel\Firm) {
            return $this
                ->addUsingAlias(ContactTableMap::COL_FIRM_ID, $firm->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(ContactTableMap::COL_FIRM_ID, $firm->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    /**
     * Deletes all rows from the firm_contacts table.
     *
