...
class AdminTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'PropelModel.Map.AdminTableMap';
     ...
     */
    const OM_CLASS = '\\PropelModel\\Admin';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PropelModel.Admin';
     ...
     */
    const COL_LOGIN = 'admin.login';

    /**
     * the column name for the hash field
     */
    const COL_HASH = 'admin.hash';

    /**
     * the column name for the last_login field
     */
    const COL_LAST_LOGIN = 'admin.last_login';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Login', 'Hash', 'LastLogin', ),
        self::TYPE_CAMELNAME     => array('id', 'login', 'hash', 'lastLogin', ),
        self::TYPE_COLNAME       => array(AdminTableMap::COL_ID, AdminTableMap::COL_LOGIN, AdminTableMap::COL_HASH, AdminTableMap::COL_LAST_LOGIN, ),
        self::TYPE_FIELDNAME     => array('id', 'login', 'hash', 'last_login', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Login' => 1, 'Hash' => 2, 'LastLogin' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'login' => 1, 'hash' => 2, 'lastLogin' => 3, ),
        self::TYPE_COLNAME       => array(AdminTableMap::COL_ID => 0, AdminTableMap::COL_LOGIN => 1, AdminTableMap::COL_HASH => 2, AdminTableMap::COL_LAST_LOGIN => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'login' => 1, 'hash' => 2, 'last_login' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\PropelModel\\Admin');
        ...
        $this->addColumn('last_login', 'LastLogin', 'INTEGER', true, null, 0);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(AdminTableMap::COL_LOGIN);
            $criteria->addSelectColumn(AdminTableMap::COL_HASH);
            $criteria->addSelectColumn(AdminTableMap::COL_LAST_LOGIN);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \PropelModel\Admin) { // it's a model object
