...
/**
 * This class defines the structure of the 'stat' table.
 *
 *
 *
...
class StatTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'PropelModel.Map.StatTableMap';
     ...
     */
    const OM_CLASS = '\\PropelModel\\Stat';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PropelModel.Stat';
     ...
     */
    const COL_ID = 'stat.id';

    /**
     * the column name for the entity_id field
     */
    const COL_ENTITY_ID = 'stat.entity_id';

    /**
     * the column name for the city_id field
     */
    const COL_CITY_ID = 'stat.city_id';

    /**
     * the column name for the count field
     */
    const COL_COUNT = 'stat.count';

    /**
     * the column name for the fake_count field
     */
    const COL_FAKE_COUNT = 'stat.fake_count';

    /**
     * the column name for the date field
     */
    const COL_DATE = 'stat.date';

    /**
     * the column name for the type field
     */
    const COL_TYPE = 'stat.type';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'EntityId', 'CityId', 'Count', 'FakeCount', 'Date', 'Type', ),
        self::TYPE_CAMELNAME     => array('id', 'entityId', 'cityId', 'count', 'fakeCount', 'date', 'type', ),
        self::TYPE_COLNAME       => array(StatTableMap::COL_ID, StatTableMap::COL_ENTITY_ID, StatTableMap::COL_CITY_ID, StatTableMap::COL_COUNT, StatTableMap::COL_FAKE_COUNT, StatTableMap::COL_DATE, StatTableMap::COL_TYPE, ),
        self::TYPE_FIELDNAME     => array('id', 'entity_id', 'city_id', 'count', 'fake_count', 'date', 'type', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'EntityId' => 1, 'CityId' => 2, 'Count' => 3, 'FakeCount' => 4, 'Date' => 5, 'Type' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'entityId' => 1, 'cityId' => 2, 'count' => 3, 'fakeCount' => 4, 'date' => 5, 'type' => 6, ),
        self::TYPE_COLNAME       => array(StatTableMap::COL_ID => 0, StatTableMap::COL_ENTITY_ID => 1, StatTableMap::COL_CITY_ID => 2, StatTableMap::COL_COUNT => 3, StatTableMap::COL_FAKE_COUNT => 4, StatTableMap::COL_DATE => 5, StatTableMap::COL_TYPE => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'entity_id' => 1, 'city_id' => 2, 'count' => 3, 'fake_count' => 4, 'date' => 5, 'type' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\PropelModel\\Stat');
        $this->setPackage('PropelModel');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('entity_id', 'EntityId', 'INTEGER', true, null, null);
        $this->addForeignKey('city_id', 'CityId', 'INTEGER', 'region', 'id', true, null, null);
        $this->addColumn('count', 'Count', 'INTEGER', false, null, 0);
        $this->addColumn('fake_count', 'FakeCount', 'INTEGER', false, null, 0);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(StatTableMap::COL_ENTITY_ID);
            $criteria->addSelectColumn(StatTableMap::COL_CITY_ID);
            $criteria->addSelectColumn(StatTableMap::COL_COUNT);
            $criteria->addSelectColumn(StatTableMap::COL_FAKE_COUNT);
            $criteria->addSelectColumn(StatTableMap::COL_DATE);
            $criteria->addSelectColumn(StatTableMap::COL_TYPE);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.entity_id');
            $criteria->addSelectColumn($alias . '.city_id');
            $criteria->addSelectColumn($alias . '.count');
            $criteria->addSelectColumn($alias . '.fake_count');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \PropelModel\Stat) { // it's a model object
