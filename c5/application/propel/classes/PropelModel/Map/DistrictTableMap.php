...
class DistrictTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'PropelModel.Map.DistrictTableMap';
     ...
     */
    const OM_CLASS = '\\PropelModel\\District';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PropelModel.District';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Data', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'data', ),
        self::TYPE_COLNAME       => array(DistrictTableMap::COL_ID, DistrictTableMap::COL_NAME, DistrictTableMap::COL_DATA, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'data', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Data' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'data' => 2, ),
        self::TYPE_COLNAME       => array(DistrictTableMap::COL_ID => 0, DistrictTableMap::COL_NAME => 1, DistrictTableMap::COL_DATA => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'data' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\PropelModel\\District');
  ...
  array (
    ...
    /**
     * Method to invalidate the instance pool of all tables related to district     * by a foreign key with ON DELETE CASCADE
     */
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(DistrictTableMap::COL_DATA);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \PropelModel\District) { // it's a model object
