...
/**
 * This class defines the structure of the 'firm_contacts' table.
 *
 *
 *
...
class ContactTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'PropelModel.Map.ContactTableMap';
     ...
     */
    const TABLE_NAME = 'firm_contacts';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\PropelModel\\Contact';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PropelModel.Contact';
     ...
     */
    const COL_ID = 'firm_contacts.id';

    /**
     * the column name for the firm_id field
     */
    const COL_FIRM_ID = 'firm_contacts.firm_id';

    /**
     * the column name for the type field
     */
    const COL_TYPE = 'firm_contacts.type';

    /**
     * the column name for the value field
     */
    const COL_VALUE = 'firm_contacts.value';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('id', 'FirmId', 'Type', 'Value', ),
        self::TYPE_CAMELNAME     => array('id', 'firmId', 'type', 'value', ),
        self::TYPE_COLNAME       => array(ContactTableMap::COL_ID, ContactTableMap::COL_FIRM_ID, ContactTableMap::COL_TYPE, ContactTableMap::COL_VALUE, ),
        self::TYPE_FIELDNAME     => array('id', 'firm_id', 'type', 'value', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('id' => 0, 'FirmId' => 1, 'Type' => 2, 'Value' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'firmId' => 1, 'type' => 2, 'value' => 3, ),
        self::TYPE_COLNAME       => array(ContactTableMap::COL_ID => 0, ContactTableMap::COL_FIRM_ID => 1, ContactTableMap::COL_TYPE => 2, ContactTableMap::COL_VALUE => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'firm_id' => 1, 'type' => 2, 'value' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    {
        // attributes
        $this->setName('firm_contacts');
        $this->setPhpName('Contact');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\PropelModel\\Contact');
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ContactTableMap::COL_FIRM_ID);
            $criteria->addSelectColumn(ContactTableMap::COL_TYPE);
            $criteria->addSelectColumn(ContactTableMap::COL_VALUE);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \PropelModel\Contact) { // it's a model object
