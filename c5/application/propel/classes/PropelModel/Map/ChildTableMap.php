...
/**
 * This class defines the structure of the 'firm_childs' table.
 *
 *
 *
...
class ChildTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'PropelModel.Map.ChildTableMap';
     ...
     */
    const TABLE_NAME = 'firm_childs';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\PropelModel\\Child';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PropelModel.Child';
     ...
     */
    const COL_ID = 'firm_childs.id';

    /**
     * the column name for the firm_id field
     */
    const COL_FIRM_ID = 'firm_childs.firm_id';

    /**
     * the column name for the value field
     */
    const COL_VALUE = 'firm_childs.value';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('id', 'FirmId', 'Value', ),
        self::TYPE_CAMELNAME     => array('id', 'firmId', 'value', ),
        self::TYPE_COLNAME       => array(ChildTableMap::COL_ID, ChildTableMap::COL_FIRM_ID, ChildTableMap::COL_VALUE, ),
        self::TYPE_FIELDNAME     => array('id', 'firm_id', 'value', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('id' => 0, 'FirmId' => 1, 'Value' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'firmId' => 1, 'value' => 2, ),
        self::TYPE_COLNAME       => array(ChildTableMap::COL_ID => 0, ChildTableMap::COL_FIRM_ID => 1, ChildTableMap::COL_VALUE => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'firm_id' => 1, 'value' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    {
        // attributes
        $this->setName('firm_childs');
        $this->setPhpName('Child');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\PropelModel\\Child');
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ChildTableMap::COL_ID);
            $criteria->addSelectColumn(ChildTableMap::COL_FIRM_ID);
            $criteria->addSelectColumn(ChildTableMap::COL_VALUE);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \PropelModel\Child) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(ChildTableMap::DATABASE_NAME);
            $criteria->add(ChildTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(ChildTableMap::COL_ID) && $criteria->keyContainsValue(ChildTableMap::COL_ID) ) {
